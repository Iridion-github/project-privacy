  ...
  const paragraphs = {
    ita: [
      ...
      },
      {
        ...
        html: `<p style="text-align: justify; " align="justify"><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">In alcuni casi, tuttavia, la formazione viene addirittura considerata come un vero e proprio obbligo giuridico ovvero contribuisce a creare le premesse per l&rsquo;efficacia di modelli organizzativi finalizzati ad evitare la realizzazione di specifiche violazioni.</span></span></p>`,
      },
      {
        orientation: "center",
        content:
      ...
      },
      {
        ...
        html: `<p style=""><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;"></span></span><span style="font-size: medium; font-family: Verdana, sans-serif;">La formazione permette di ridurre le probabilit&agrave; che si pongano in essere condotte in violazione delle disposizioni e, in ultima analisi, si commettano errori, con conseguente impatto per l&rsquo;azienda in termini sanzionatori o reputazionali.</span></p>`,
      },
      {
        orientation: "center",
        content:
      ...
      },
      {
        ...
        html: `<p style="" align="justify"><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">Le modalit&agrave; attraverso cui realizzare la formazione, cos&igrave; come tutte le misure organizzative, sono ovviamente lasciate alla discrezionalit&agrave; dei soggetti obbligati che, in virt&ugrave; di quel </span></span><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;"><em>principio di proporzionalit&agrave;,</em></span></span> <span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">dovranno valutare l&rsquo;idoneit&agrave; di qualsiasi azione in relazione alle caratteristiche e alla complessit&agrave; delle strutture organizzative interessate, fermo restando, ovviamente, l&rsquo;adeguata documentazione e formalizzazione (principio di accountability) delle misure adottate.</span></span></p>`,
      },
      {
        orientation: "center",
        content:
    ...
    eng: [
      ...
      },
      {
        ...
        html: `<p style="text-align: justify; " align="justify"><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">There are different aspects that allow companies to be competitive, but what is truly indispensable today is the ability to grasp the opportunities offered by new technologies and, above all, the possibility of having motivated, capable and competent human resources. </span></span><span style="color: #000000;"><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">Training in this context favors a powerful mechanism of inclusion, motivation and involvement. </span></span></span></p>`,
      },
      {
        orientation: "center",
        content:
      ...
      },
      {
        ...
        html: `<p style="text-align: justify; " align="justify"><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">In this sense, the training activity must be permanent (ie with reference to the entire life cycle of the worker) and characterized by a frequency that allows to grasp the changes in internal and external contexts.</span></span></p>`,
      },
      {
        orientation: "center",
        content:
      ...
      },
      {
        ...
        html: `<p style="text-align: justify; " align="justify"><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">In some cases, however, training is even considered as a real legal obligation or helps to create the conditions for the effectiveness of organizational models aimed at avoiding the implementation of specific violations.</span></span></p>`,
      },
      {
        orientation: "center",
        content:
      ...
      },
      {
        ...
        html: `<p style=""><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;"></span></span><span style="font-size: medium; font-family: Verdana, sans-serif;">Training makes it possible to reduce the likelihood of conduct in violation of the provisions and, ultimately, mistakes are made, with a consequent impact on the company in terms of sanctions or reputational.</span></p>`,
      },
      {
        orientation: "center",
        content:
      ...
      },
      {
        ...
        html: `<p style="" align="justify"><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">The modalities through which to carry out the training, as well as all the organizational measures, are obviously left to the discretion of the obliged subjects who, by virtue of that </span></span><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;"><em>principle of proportionality</em></span></span> <span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">, will have to evaluate the suitability of any action in relation to the characteristics and complexity of the structures organizations concerned, obviously without prejudice to the adequate documentation and formalization (principle of accountability) of the measures adopted.</span></span></p>`,
      },
      {
        orientation: "center",
        content:
      ...
      },
      {
        ...
        html: `<p style="" align="justify"><span style="font-family: Verdana, sans-serif;"><span style="font-size: medium;">
