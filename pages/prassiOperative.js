...
function prassiOperative(props) {
  ...
  const handleSetPrassiOperativaSelected = useCallback(norm => {
    setPrassiOperativaSelected(norm);
  });
  ...
  const handleGoBackBtn = () => {
    if (prassiOperativaSelected && !subSectionSelected) {
      handleSetPrassiOperativaSelected(null);
    } else if (prassiOperativaSelected && subSectionSelected) {
  ...
  useEffect(() => {
    if (prassiOperativaSelected && subSectionSelected && fileSelected) {
  ...
  }, [prassiOperativaSelected, subSectionSelected, fileSelected]);

  const showSelectionPrassiOperativa = useMemo(() => {
    return !prassiOperativaSelected;
  }, [prassiOperativaSelected]);

  const showSelectionSubSection = useMemo(() => {
    return prassiOperativaSelected && !subSectionSelected;
  }, [prassiOperativaSelected, subSectionSelected]);

  const showPdfFileList = useMemo(() => {
    return prassiOperativaSelected && subSectionSelected && subSectionSelected.fileUrls && subSectionSelected.fileUrls.length;
  }, [prassiOperativaSelected, subSectionSelected]);

  const showLinksList = useMemo(() => {
    return prassiOperativaSelected && subSectionSelected && subSectionSelected.linkUrls && subSectionSelected.linkUrls.length;
  }, [prassiOperativaSelected, subSectionSelected]);
            ...
            <Container className="justify-content-center p-0">
              <Card className="w-100 p-2 responsive-width-card">
                ...
                <Card.Body>
                  ...
                  {showSelectionPrassiOperativa && <PrassiOperativeChoice prassiOperative={props.prassiOperative} setPrassiOperativa={handleSetPrassiOperativaSelected} />}
                  {showSelectionSubSection && (
                    <PrassiOperativeChoice
                      prassiOperative={prassiOperativaSelected.subSections}
                      setPrassiOperativa={handleSetSubsectionSelected}
        ...
        subSections: [
          {
            ...
            title: "Europea",
            fileUrls: [
              { id: "0", url: "/prassiOperative/anticorruzione1.pdf", title: "Anticorruzione - Europea - 1 (europea)" },
              { id: "1", url: "/prassiOperative/anticorruzione1.pdf", title: "Anticorruzione - Europea - 2 (europea)" },
            ],
          },
          {
            id: "nazionale",
            title: "Nazionale",
            fileUrls: [
              { id: "0", url: "/prassiOperative/anticorruzione1.pdf", title: "Anticorruzione - Nazionale - 1 (europea)" },
              { id: "1", url: "/prassiOperative/anticorruzione1.pdf", title: "Anticorruzione - Nazionale - 2 (europea)" },
            ],
          },
          {
            id: "anac",
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/anticorruzione1.pdf", title: "Anticorruzione - ANAC - Autorità Nazionale Anti-Corruzione - 1 (europea)" },
              { id: "1", url: "/prassiOperative/anticorruzione1.pdf", title: "Anticorruzione - ANAC - Autorità Nazionale Anti-Corruzione - 2 (europea)" },
            ],
          },
          {
            id: "codiceAppalti",
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/anticorruzione1.pdf", title: "Anticorruzione - Codice appalti - 1 (europea)" },
              { id: "1", url: "/prassiOperative/anticorruzione1.pdf", title: "Anticorruzione - Codice appalti - 2 (europea)" },
            ],
          },
        ],
      },
        ...
        subSections: [
          {
            ...
            title: "Europea",
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - Europea - 1 (europea)" },
              { id: "1", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - Europea - 2 (europea)" },
            ],
          },
          {
            id: "nazionale",
            title: "Nazionale",
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - Nazionale - 1 (europea)" },
              { id: "1", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - Nazionale - 2 (europea)" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("organismiSovranazionali") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("ministeroEconomiaFinanze") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("bancaItalia") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("unitaInformazioneFinanziaria") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("guardiaFinanza") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("autoritaBancariaEuropea") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("terrorismoInternazionale") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("valuteVirtuali") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            ...
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Antiriciclaggio - " + getHumanizedTitle("proliferazioneArmiDistruzioneMassa") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
        ],
        ...
        subSections: [
          {
            ...
            fileUrls: [{ id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Regolamento UE 679/2016 - GDPR" }],
            linkUrls: [
          ...
          },
          {
            ...
            fileUrls: [{ id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Codice Privacy" }],
            linkUrls: [
              { id: "0", url: "https://www.google.it/", title: "link numero 1" },
              { id: "1", url: "https://www.google.it/", title: "link numero 2" },
              { id: "2", url: "https://www.google.it/", title: "link numero 3" },
        ...
        subSections: [
          {
            ...
            title: getHumanizedTitle("europea"),
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: getHumanizedTitle("europea") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
          {
            id: "nazionale",
            title: getHumanizedTitle("nazionale"),
            fileUrls: [{ id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "D.Lgs 231/2001" }],
          },
          {
            id: "lineeGuidaAssCategoria",
            title: getHumanizedTitle("lineeGuidaAssCategoria"),
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: getHumanizedTitle("lineeGuidaAssCategoria") },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Regolamento UE 2016/679" },
            ],
          },
        ],
      },
      {
        ...
        subSections: [
          ...
          },
          {
            id: "nazionale",
            title: getHumanizedTitle("nazionale"),
            fileUrls: [{ id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "D.Lgs " + getHumanizedTitle("nazionale") }],
          },
          {
            id: "provvAutoGaranteConcorrMercato",
            title: getHumanizedTitle("provvAutoGaranteConcorrMercato"),
            fileUrls: [{ id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: getHumanizedTitle("provvAutoGaranteConcorrMercato") }],
          },
        ],
      },
      {
        ...
        subSections: [
          {
            id: "europea",
            title: getHumanizedTitle("europea"),
            fileUrls: [{ id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: getHumanizedTitle("europea") }],
          },
          {
            id: "nazionale",
            title: getHumanizedTitle("nazionale"),
            fileUrls: [
              { id: "0", url: "/prassiOperative/antiriciclaggio1.pdf", title: "Codice Antimafia" },
              { id: "1", url: "/prassiOperative/regolamento_UE_2016_679.pdf", title: "Codice penale" },
            ],
