      ...
      <Row className="w-100 text-center align-items-center justify-content-center m-auto">
        <Row className="w-100 ml-0 mr-0 mb-3 quiz-body ">
          <Row className="w-100 ml-0 mr-0 mb-3">
            <Col md={{ span: 1 }} className=""></Col>
            <Col md={{ span: 2 }} className="d-flex align-items-center justify-content-end">
              {props.questionCounter > 1 && (
                <Button block size="lg" variant="info" disabled={props.timesUp} onClick={() => props.setQuestionCounter(props.questionCounter - 1)}>
            ...
            <Col md={2} className="d-flex align-items-center justify-content-start">
              ...
              {props.questionCounter === props.selectedQuiz.questions.length && (
                <Button block className="pt-3 pb-3" variant="success" disabled={props.timesUp} onClick={() => props.handleShowResults(true)}>
