...
module.exports = __webpack_require__("rfNB");
...
const ReviewTopicsSchema = new mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.Schema({
  name: {
    type: Object,
    ita: {
      type: String,
...
/* harmony default export */ __webpack_exports__["a"] = (mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.models.ReviewTopics || mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.model("ReviewTopics", ReviewTopicsSchema));
...
/* harmony import */ var _models_ReviewTopics__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("RT7c");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  let targetTopic = await _models_ReviewTopics__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].findOne({
    id: id
  });
  ...
  switch (method) {
    ...
    case "PUT":
      try {
        const updatedReview = Object(_utils_dbFunctions__WEBPACK_IMPORTED_MODULE_2__[/* whichToUpdate */ "a"])(body, targetReview);
        ...
        return res.status(400).json({
          success: false,
          error: "Failed update of existing review!"
        });
      }
    ...
    case "PUT":
      try {
        ...
        return res.status(400).json({
          success: false,
          error: "Failed update of existing review topic!"
        });
      }

    case "DELETE":
      try {
        await _models_ReviewTopics__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].deleteOne({
          _id: targetTopic.id
        });
        await targetTopic.save();
        return res.status(200).json({
        ...
        return res.status(400).json({
          success: false,
          error: "Failed deletion of review!"
        });
      }
