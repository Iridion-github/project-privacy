...
module.exports = __webpack_require__("4SaT");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  let targetReview = await _models_Review__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].findOne({
    id: id
  });
  ...
  if (!targetReview) {
    return res.status(400).json({
      success: false,
      error: "No review found for that id!"
    });
  }
  ...
  switch (method) {
    ...
    case "DELETE":
      try {
        await _models_Review__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].deleteOne({
          _id: targetReview.id
        });
        await targetReview.save();
        return res.status(200).json({
