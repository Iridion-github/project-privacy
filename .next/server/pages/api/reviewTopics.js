...
module.exports = __webpack_require__("EXYl");
...
/* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
  ...
  switch (method) {
    case "GET":
      try {
        const reviewTopics = await _models_ReviewTopics__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].find();
        res.status(200).json({
          success: true,
          data: reviewTopics
        });
    ...
    case "POST":
      try {
        const glossaryWord = await _models_ReviewTopics__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"].create(req.body);
        res.status(201).json({
          success: true,
          data: glossaryWord
        });
